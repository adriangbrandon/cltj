...
#ifndef LTJ_ITERATOR_METATRIE_V2_HPP
#define LTJ_ITERATOR_METATRIE_V2_HPP
...
namespace ltj {
    ...
    class ltj_iterator_metatrie_v2 {
    ...
    private:
        ...
        void copy(const ltj_iterator_metatrie_v2 &o) {
    ...
    public:
        ...
        */
        ...
        ltj_iterator_metatrie_v2() = default;
        ltj_iterator_metatrie_v2(const triple_pattern *triple, index_scheme_type *index) {
        ...
        */
        ...
        //! Copy constructor
        ltj_iterator_metatrie_v2(const ltj_iterator_metatrie_v2 &o) {
            copy(o);
        }

        //! Move constructor
        ltj_iterator_metatrie_v2(ltj_iterator_metatrie_v2 &&o) {
            *this = std::move(o);
        }

        //! Copy Operator=
        ltj_iterator_metatrie_v2 &operator=(const ltj_iterator_metatrie_v2 &o) {
            if (this != &o) {
                copy(o);
            }
            return *this;
        ...
        //! Move Operator=
        ltj_iterator_metatrie_v2 &operator=(ltj_iterator_metatrie_v2 &&o) {
            if (this != &o) {
        ...
        void swap(ltj_iterator_metatrie_v2 &o) {
        ...
        inline size_type children(state_type state) const{
            ...
            if (m_nfixed == 1){
                ...
                if (m_status_i && m_nfixed == 2) { //partial trie
                    t_i = cltj::ts_full_map[m_trie_i/2];
                }
            }
    ...
    template<class index_scheme_t, class var_t, class cons_t>
    uint64_t ltj_iterator_metatrie_v2<index_scheme_t, var_t, cons_t>::parent() const {
