 ...
 */
#ifndef LTJ_ITERATOR_DYN_HPP
#define LTJ_ITERATOR_DYN_HPP
...
namespace ltj {
    ...
    private:
        ...
        void copy(const ltj_iterator_dyn &o) {
    ...
    public:
        ...
        */
        ...
        ltj_iterator_dyn() = default;
        ltj_iterator_dyn(const triple_pattern *triple, index_scheme_type *index) {
        ...
        */
        ...
        //! Copy constructor
        ltj_iterator_dyn(const ltj_iterator_dyn &o) {
            copy(o);
        }

        //! Move constructor
        ltj_iterator_dyn(ltj_iterator_dyn &&o) {
            *this = std::move(o);
        }

        //! Copy Operator=
        ltj_iterator_dyn &operator=(const ltj_iterator_dyn &o) {
            if (this != &o) {
                copy(o);
            }
            return *this;
        ...
        //! Move Operator=
        ltj_iterator_dyn &operator=(ltj_iterator_dyn &&o) {
            if (this != &o) {
    ...
    template<class index_scheme_t, class var_t, class cons_t>
    uint64_t ltj_iterator_dyn<index_scheme_t, var_t, cons_t>::parent() const {
